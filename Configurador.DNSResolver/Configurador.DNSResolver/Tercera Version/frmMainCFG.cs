    ...
    public partial class frmMainCFG : Form
    {
        ...
        public void FormatTables()
        {
            try {
                ...
                //LBActionsList.Columns["TA"].
                //LBActionsList.DisplayMember = "TA";
                //LBActionsList.ValueMember = "TA";
                //LBActionsList.co
        ...
        public void EliminarTAs()
        {
            try
            {
                ...
                if (Eliminado)
                {
                    MessageBox.Show("Se ha eliminado el TA.", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else { MessageBox.Show("El TA proporcionado no se encuentra en la Lista.", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information);}
                }
